...
## Team Members
${results.Control.TeamMembers.reduce((s,m,i) => s+(m.Name + " => idle days " + Statistics.ToDecimalPlace(m.TimeIdle,0) + ", skip waiting count: turn " + m.SkipNotMyTurn + ", preq: " + m.SkipPrerequisite + "\n"), "")} 
...
## Team Members
${results.Experiment.TeamMembers.reduce((s,m) => s+(m.Name + " => idle days " + Statistics.ToDecimalPlace(m.TimeIdle,0) + ", skip waiting count: turn " + m.SkipNotMyTurn + ", preq " + m.SkipPrerequisite + "\n"), "")} 
