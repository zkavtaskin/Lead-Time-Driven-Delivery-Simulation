...
describe('BnBBacklogDecoder', () => {
    ...
    it('Decode, stories have dependency, pattern is set to prioritise prerequisiteId only', () => {
    ...
    it('Decode, stories have dependencies, pattern is set to prioritise prerequisiteId only', () => {
    ...
    it('Decode, stories are delivered by 2 team members, pattern is set to prioritise by single team member only i.e. in reverse', () => {
    ...
    it('Decode, stories have dependencies, pattern is set to prioritise by prerequisiteId first and then single team member', () => {
